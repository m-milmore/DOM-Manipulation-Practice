...
const updateCollections = (id, direction) => {
  const currNode = document.getElementById(id);
  if (direction === "toMain") {
    currNode.children[0].classList.remove("fa-heart-crack");
    currNode.children[0].classList.add("fa-heart-circle-plus");
    main.appendChild(currNode);
  } else {
    currNode.children[0].classList.remove("fa-heart-circle-plus");
    currNode.children[0].classList.add("fa-heart-crack");
    favs.appendChild(currNode);
  }
};
